# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-11-16 22:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire', models.BooleanField(default=False)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reserve_order_book', to='librarian.AllBook')),
                ('the_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reserve_order_isbn', to='librarian.Book')),
        ...
        migrations.AddField(
            model_name='book',
            name='place',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='librarian.BookLocation'),
        ),
        migrations.AddField(
            model_name='book',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='librarian.BookType'),
        ),
        migrations.AddField(
            model_name='allbook',
            name='the_book',
